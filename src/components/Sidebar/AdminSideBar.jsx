...
import BolstaarLogo from '../../Assets/Images/BolStar_logo.png'
            ...
            <div className="flex h-screen flex-col justify-between pt-2 pb-6">
                <div>
                    ...
                    <ul className="mt-6 space-y-2 tracking-wide">
                        ...
                        <li className="min-w-max">
                            <a href="#" className="group flex items-center space-x-4 px-4 py-3 text-gray-600 hover:bg-gradient-to-r from-sky-600 to-cyan-400 hover:text-white">
                                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                                    <path className="fill-current text-gray-600 group-hover:text-cyan-600" fill-rule="evenodd" d="M2 5a2 2 0 012-2h8a2 2 0 012 2v10a2 2 0 002 2H4a2 2 0 01-2-2V5zm3 1h6v4H5V6zm6 6H5v2h6v-2z" clipRule="evenodd" />
                        ...
                        <li className="min-w-max">
                            <a href="#" className="group flex items-center space-x-4  px-4 py-3 text-gray-600 hover:bg-gradient-to-r from-sky-600 to-cyan-400 hover:text-white">
                                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                                    ...
                                    <path className="fill-current text-gray-600 group-hover:text-cyan-600" fill-rule="evenodd" d="M18 9H2v5a2 2 0 002 2h12a2 2 0 002-2V9zM4 13a1 1 0 011-1h1a1 1 0 110 2H5a1 1 0 01-1-1zm5-1a1 1 0 100 2h1a1 1 0 100-2H9z" clipRule="evenodd" />
                                </svg>
