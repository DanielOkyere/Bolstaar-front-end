        ...
        <div className='bg-white p-2 rounded'>
          <form className='mb-4 items-center'>
            <div className='mb-4  md:w-full'>
              ...
              <input
                type='text' className='w-full border rounded p-2 outline-none focus:shadow-outline'
            ...
            <div className='mb-4 md:w-full'>
              ...
              <input
                type='item_quantity' className='w-full border rounded p-2 outline-none focus:shadow-outline'
            ...
            <div className='mb-4 md:w-full'>
              ...
              <input
                type='contact_person' className='w-full border rounded p-2 outline-none focus:shadow-outline'
            ...
            <div className='mb-4 md:w-full'>
              ...
              <input
                type='delivery_to' className='w-full border rounded p-2 outline-none focus:shadow-outline'
