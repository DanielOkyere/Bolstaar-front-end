      ...
      <nav className="relative p-6 h-full overflow-y-auto">
        <div className="flex flex-col justify-between h-full">
          ...
          <div className="flex flex-col flex-wrap">
            ...
            <Link to='/login'
            className="w-full  text-center py-4 rounded-full inline-block  text-lg  leading-5 text-blue-50 bg-green-700 hover:bg-green-600 font-semibold focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 rounded-full"
           
          >
      Login
          </Link>
          <Link to='/signup/main'
            className=" w-full text-center  py-4 rounded-full inline-block  text-lg  leading-5 text-blue-50 bg-green-500 hover:bg-green-600 font-semibold focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 rounded-full"
